...
import com.sabmiller.constants.SabmbackofficeConstants;
 ...
 */
public class SabmbackofficeManager extends GeneratedSabmbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SabmbackofficeManager.class.getName());
	 ...
	 */
	public static SabmbackofficeManager getInstance()
	{
		return (SabmbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SabmbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SabmbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SabmbackofficeManager called.");
		}
	}
