 ...
 */
package com.apb.integration.service.impl;
...
public class DefaultApbintegrationService implements ApbintegrationService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultApbintegrationService.class);
	...
	public void createLogo(final String logoCode)
	{
		...
		mediaService.setStreamForMedia(media, imageStream);
		...
		try 
		{
			...
			LOG.error("IOException occured while closing image stearming." + e.getMessage(), e);
		}
	}
	...
	{
		return DefaultApbintegrationService.class.getResourceAsStream("/apbintegration/sap-hybris-platform.png");
	}
