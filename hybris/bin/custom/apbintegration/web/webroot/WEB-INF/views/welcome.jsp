...
<html>
<head>
    <title>Welcome to apbintegration</title>
    <link rel="stylesheet" href="<c:url value="/static/apbintegration-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "apbintegration" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/apbintegration-items.xml</b> - here you can model your items</li>
            <li><b>resources/apbintegration-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/apbintegration-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/apbintegration-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/apbintegration-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
