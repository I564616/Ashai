 ...
 *  
 */
package com.sabmiller.staff.singlesignon.jalo;
...
/**
 * This is the extension manager of the Sabmsinglesignon extension.
 */
public class SabmsinglesignonManager extends GeneratedSabmsinglesignonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SabmsinglesignonManager.class.getName());
	 ...
	 */
	public static SabmsinglesignonManager getInstance()
	{
		return (SabmsinglesignonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SabmsinglesignonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SabmsinglesignonManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SabmsinglesignonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SabmsinglesignonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SabmsinglesignonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
