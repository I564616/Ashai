 ...
 *
 */
package com.sabmiller.staff.singlesignon.constants;

/**
 * Global class for all Sabmsinglesignon constants. You can add global constants for your extension into this class.
 */
public final class SabmsinglesignonConstants extends GeneratedSabmsinglesignonConstants
{
	public static final String EXTENSIONNAME = "sabmsinglesignon";

	private SabmsinglesignonConstants()
	{
	...
	public static final String ASAHI_STAFF_PORTAL = "asahiStaffPortal";

	public static final String ADMIN_GROUP = "admingroup";

	public static final String BDE_GROUP = "bdegroup";

	public static final String CMS_COCKPIT = "cmscockpit";
