...
import de.hybris.platform.asahiocc.dto.product.AlcoholTypeListWsDTO;
import de.hybris.platform.asahiocc.dto.product.AlcoholTypeWsDTO;
import de.hybris.platform.asahiocc.dto.product.BrandListWsDTO;
import de.hybris.platform.asahiocc.dto.product.BrandWsDTO;
import de.hybris.platform.asahiocc.dto.product.FlavourListWsDTO;
import de.hybris.platform.asahiocc.dto.product.FlavourWsDTO;
import de.hybris.platform.asahiocc.dto.product.ItemGroupListWsDTO;
import de.hybris.platform.asahiocc.dto.product.ItemGroupWsDTO;
import de.hybris.platform.asahiocc.dto.product.PackageTypeListWsDTO;
import de.hybris.platform.asahiocc.dto.product.PackageTypeWsDTO;
import de.hybris.platform.asahiocc.dto.product.ProductGroupListWsDTO;
import de.hybris.platform.asahiocc.dto.product.ProductGroupWsDTO;
import de.hybris.platform.asahiocc.dto.product.SubProductGroupListWsDTO;
import de.hybris.platform.asahiocc.dto.product.SubProductGroupWsDTO;
...
public class AsahiProductReferenceController
{
	 ...
	 */
	@RequestMapping(value = "/importProductGroup", method = RequestMethod.POST, consumes =
	 ...
	 *            the webservice validation exception
	 */
	@RequestMapping(value = "/importAlcoholType", method = RequestMethod.POST, consumes =
	{ MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseBody
	 ...
	 *            the webservice validation exception
	 */
	@RequestMapping(value = "/importPackageType", method = RequestMethod.POST, consumes =
	{ MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseBody
	 ...
	 *            the webservice validation exception
	 */
	@RequestMapping(value = "/importFlavour", method = RequestMethod.POST, consumes =
	{ MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseBody
	 ...
	 *            the webservice validation exception
	 */
	@RequestMapping(value = "/importBrand", method = RequestMethod.POST, consumes =
	{ MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseBody
	 ...
	 *            the webservice validation exception
	 */
	@RequestMapping(value = "/importItemGroup", method = RequestMethod.POST, consumes =
	{ MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseBody
	 ...
	 *            the webservice validation exception
	 */
	@RequestMapping(value = "/importSubProductGroup", method = RequestMethod.POST, consumes =
	{ MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseBody
