...
import de.hybris.platform.asahiocc.dto.customer.AccountGroupsListWsDTO;
import de.hybris.platform.asahiocc.dto.customer.AccountGroupsWsDTO;
import de.hybris.platform.asahiocc.dto.customer.AccountTypeListWsDTO;
import de.hybris.platform.asahiocc.dto.customer.AccountTypeWsDTO;
import de.hybris.platform.asahiocc.dto.customer.BannerGroupsListWsDTO;
import de.hybris.platform.asahiocc.dto.customer.BannerGroupsWsDTO;
import de.hybris.platform.asahiocc.dto.customer.ChannelListWsDTO;
import de.hybris.platform.asahiocc.dto.customer.ChannelWsDTO;
import de.hybris.platform.asahiocc.dto.customer.LicenceClassListWsDTO;
import de.hybris.platform.asahiocc.dto.customer.LicenceClassWsDTO;
import de.hybris.platform.asahiocc.dto.customer.LicenseTypesListWsDTO;
import de.hybris.platform.asahiocc.dto.customer.LicenseTypesWsDTO;
import de.hybris.platform.asahiocc.dto.customer.SubChannelListWsDTO;
import de.hybris.platform.asahiocc.dto.customer.SubChannelWsDTO;
...
public class AsahiB2BUnitReferenceController
{
	 ...
	 */
	@RequestMapping(value = "/importAccountGroup", method = RequestMethod.POST, consumes =
	 ...
	 *            the webservice validation exception
	 */
	@RequestMapping(value = "/importAccountType", method = RequestMethod.POST, consumes =
	{ MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseBody
	 ...
	 *            the webservice validation exception
	 */
	@RequestMapping(value = "/importBannerGroup", method = RequestMethod.POST, consumes =
	{ MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseBody
	 ...
	 *            the webservice validation exception
	 */
	@RequestMapping(value = "/importSubChannel", method = RequestMethod.POST, consumes =
	{ MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseBody
	 ...
	 *            the webservice validation exception
	 */
	@RequestMapping(value = "/importChannel", method = RequestMethod.POST, consumes =
	{ MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseBody
	 ...
	 *            the webservice validation exception
	 */
	@RequestMapping(value = "/importLicenseType", method = RequestMethod.POST, consumes =
	{ MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseBody
	 ...
	 *            the webservice validation exception
	 */
	@RequestMapping(value = "/importLicenceClass", method = RequestMethod.POST, consumes =
	{ MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseBody
