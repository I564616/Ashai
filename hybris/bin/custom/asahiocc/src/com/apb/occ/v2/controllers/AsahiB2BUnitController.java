...
import de.hybris.platform.asahiocc.dto.b2bunit.ApbAddressListWsDTO;
import de.hybris.platform.asahiocc.dto.b2bunit.ApbB2BUnitListWsDTO;
...
public class AsahiB2BUnitController extends AsahiBaseController
{
	 ...
	 */
	@RequestMapping(value = "/importCustomer", method = RequestMethod.POST, consumes =
	...
	@RequestMapping(value = "/addresses", method = RequestMethod.POST, consumes =
	{ MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseBody
