 ...
 *
 * @param <WebServiceResponse> the generic type
 */
public class SABMAbstractGetRestRequestHandler<WebServiceResponse> implements SABMGetRestRequestHandler<WebServiceResponse> {
     ...
     * The Constant LOG.
     */
    private final static Logger LOG = LoggerFactory.getLogger(SABMAbstractGetRestRequestHandler.class);
     ...
     */
    @Override
    public WebServiceResponse sendGetRequest(final String url, final Map<String, Object> urlVariables) throws SABMIntegrationException {
    ...
    protected HttpHeaders getHttpHeaders() {
        ...
        if (mediaTypes == null || mediaTypes.isEmpty()) {
            mediaTypes = Arrays.asList(MediaType.APPLICATION_XML);
        }
     ...
     *
     * @param sabmRestTemplate the sabmRestTemplate to set
     */
