 ...
 *  
 */
package com.sabmiller.integration.jalo;
...
import com.sabmiller.integration.constants.SabmintegrationConstants;



/**
 * This is the extension manager of the Sabmintegration extension.
 */
public class SabmintegrationManager extends GeneratedSabmintegrationManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SabmintegrationManager.class.getName());
	 ...
	 */
	public static SabmintegrationManager getInstance()
	{
		return (SabmintegrationManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SabmintegrationConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SabmintegrationManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SabmintegrationManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SabmintegrationManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SabmintegrationManager called, current tenant: " + getTenant().getTenantID());
		}
	}
