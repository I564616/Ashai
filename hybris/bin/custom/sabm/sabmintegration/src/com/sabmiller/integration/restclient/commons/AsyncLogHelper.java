...
@Component
public class AsyncLogHelper
{

	private static final Logger LOG = Logger.getLogger(AsyncLogHelper.class);
	...
	protected WebServiceLogModel generateLog(final WebServiceLogData webServiceLogData)
	{
		try
		{
			...
			LOG.debug("Service Request : " + requestXml);
			...
			LOG.debug("Service Response: " + reponseXml);
			...
			logModel.setRequest(requestXml);
			logModel.setResponse(reponseXml);
