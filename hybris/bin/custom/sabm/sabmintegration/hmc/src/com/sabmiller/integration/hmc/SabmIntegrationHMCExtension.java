 ...
 *
 */
package com.sabmiller.integration.hmc;
...
/**
 * Provides necessary meta information about the sabmintegration hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class SabmIntegrationHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(SabmIntegrationHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.sabmiller.integration.hmc.locales";
