...
import com.sabmiller.cockpits.components.liveedit.DefaultLiveEditView;
	...
	public class DefaultLiveEditCaptionComponent extends CaptionBrowserComponent
	{
				...
				final ObjectValueContainer valueContainer)
		{
			...
			if (!matchingEditorDescriptors.isEmpty())
			{
				...
				final UIEditor editor = org.apache.commons.lang3.StringUtils.isNotBlank(rowConfig.getEditor()) ? ped
