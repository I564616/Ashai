 ...
 *
 */
package com.sabmiller.cockpits.productcockpit.editor;
			...
			if (section instanceof CustomEditorSection)
			{
				...
				if (customSection.getSectionConfiguration() instanceof ExternalTaxesSectionConfiguration)
				{
					...
					if (secConfig != null)
					{
						...
						final Label rowLabel = new Label(Labels.getLabel("sabmcockpits.product.externalTaxes"));
						rowLabel.setTooltiptext(Labels.getLabel("sabmcockpits.product.externalTaxes"));
