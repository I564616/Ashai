 ...
 *
 */
package com.sabmiller.cockpits.setup;
...
import com.sabmiller.cockpits.constants.SabmCockpitsConstants;
 ...
 */
@SystemSetup(extension = SabmCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(SabmCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(SabmCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						SabmCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/sabmcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
