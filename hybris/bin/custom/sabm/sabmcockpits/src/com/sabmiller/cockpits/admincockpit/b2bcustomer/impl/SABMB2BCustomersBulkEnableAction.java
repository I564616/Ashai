...
/**
 * The Class SABMB2BCustomersBulkEnableAction.
 */
public class SABMB2BCustomersBulkEnableAction extends AbstractListViewAction
{

	/** The Constant ICON_FUNC_APPROVAL_ACTION_AVAILABLE. */
	private static final String ICON_FUNC_APPROVAL_ACTION_AVAILABLE = "cockpit/images/tick.png";

	/** The Constant LOG. */
	private static final Logger LOG = LoggerFactory.getLogger(SABMB2BCustomersBulkEnableAction.class);
		...
		if (CollectionUtils.isNotEmpty(selectedItems))
		{
			ret = new EventListener()
			{
				...
				public void onEvent(final Event arg0)
				{
					...
					Wizard.show("b2bCustomersBulkEnableWizard", hpc);
