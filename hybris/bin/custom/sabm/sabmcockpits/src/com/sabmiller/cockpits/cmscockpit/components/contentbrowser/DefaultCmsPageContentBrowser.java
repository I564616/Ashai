 ...
 *
 */
package com.sabmiller.cockpits.cmscockpit.components.contentbrowser;
...
import com.sabmiller.cockpits.cmscockpit.session.impl.DefaultCmsPageBrowserModel;
...
/**
 * The Class DefaultCmsPageContentBrowser.
 */
public class DefaultCmsPageContentBrowser extends CmsPageContentBrowser
{

	/** The Constant LOG. */
	private static final Logger LOG = LoggerFactory.getLogger(DefaultCmsPageContentBrowser.class);

	/*
	 * (non-Javadoc)
	 * 
	 * @see de.hybris.platform.cmscockpit.components.contentbrowser.CmsPageContentBrowser#createCaptionComponent()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.hybris.platform.cmscockpit.components.contentbrowser.CmsPageContentBrowser#createToolbarComponent()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.hybris.platform.cmscockpit.components.contentbrowser.CmsPageContentBrowser#updateItem(de.hybris.platform.
	 * cockpit.model.meta.TypedObject, java.util.Set, java.lang.Object)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.hybris.platform.cmscockpit.components.contentbrowser.CmsPageContentBrowser#updateStatusBar()
	 */
	@Override
