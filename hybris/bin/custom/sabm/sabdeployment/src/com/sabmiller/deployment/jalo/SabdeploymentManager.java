 ...
 *  
 */
package com.sabmiller.deployment.jalo;
...
/**
 * This is the extension manager of the Sabdeployment extension.
 */
public class SabdeploymentManager extends GeneratedSabdeploymentManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SabdeploymentManager.class.getName());
	 ...
	 */
	public static SabdeploymentManager getInstance()
	{
		return (SabdeploymentManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SabdeploymentConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SabdeploymentManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SabdeploymentManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SabdeploymentManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SabdeploymentManager called, current tenant: " + getTenant().getTenantID());
		}
	}
