 ...
 *
 */
public class APBDisabledB2Bunits extends SABMAbstracB2BCustomerTranslator
{
	private static final Logger LOG = LoggerFactory.getLogger(APBDisabledB2Bunits.class);
	...
	public String performExport(final Item item) throws ImpExException
	{
		...
		LOG.debug("Result of APB Disabled B2Bunits translation for item [{}] is [{}]", item, result);
