 ...
 *  
 */
package com.sabmiller.commons.jalo;
...
/**
 * This is the extension manager of the Sabmcommons extension.
 */
public class SabmcommonsManager extends GeneratedSabmcommonsManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SabmcommonsManager.class.getName());
	 ...
	 */
	public static SabmcommonsManager getInstance()
	{
		return (SabmcommonsManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SabmcommonsConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SabmcommonsManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SabmcommonsManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SabmcommonsManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SabmcommonsManager called, current tenant: " + getTenant().getTenantID());
		}
	}
