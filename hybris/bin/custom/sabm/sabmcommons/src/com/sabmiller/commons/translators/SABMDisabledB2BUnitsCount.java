 ...
 */
public class SABMDisabledB2BUnitsCount extends SABMAbstracB2BCustomerTranslator
{
	/** The Constant LOG. */
	...
	public String performExport(final Item item) throws ImpExException
	{
		...
		if (isValidAndSetup(item) && CollectionUtils.isNotEmpty(getCustomer().getGroups()))
		{
			...
			result = String.valueOf(b2bUnitsList.size());
			LOG.info("No of disabled B2bUnits are : ", result);
		}
