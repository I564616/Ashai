 ...
 *
 */
public class SABMB2BVenue extends SABMAbstracB2BCustomerTranslator
{
	/** The Constant LOG. */
	private static final Logger LOG = LoggerFactory.getLogger(SABMB2BVenue.class);
	...
	public String performExport(final Item item) throws ImpExException
	{
		...
		if (isValidAndSetup(item) && getCustomer().getDefaultB2BUnit() != null
				&& getCustomer().getDefaultB2BUnit().getName() != null)
		{
			result = getCustomer().getDefaultB2BUnit().getName();
		}
