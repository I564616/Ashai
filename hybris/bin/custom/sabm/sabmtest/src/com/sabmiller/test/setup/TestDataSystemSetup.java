 ...
 *
 */
package com.sabmiller.test.setup;
...
import com.sabmiller.test.constants.SabmTestConstants;
import com.sabmiller.test.orders.AcceleratorTestOrderData;
...
public class TestDataSystemSetup extends AbstractSystemSetup implements InitializingBean
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/sabmtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/sabmtest/import/reviews.impex");
