 ...
 *
 */
public abstract class AbstractStaffRegisterPageController extends AbstractStaffPageController
{
	protected static final Logger LOG = Logger.getLogger(AbstractStaffRegisterPageController.class);
