...
import com.sabmiller.staff.storefront.form.SABMCustomerSearchForm;
...
@Controller
@Scope("tenant")
public class CustomerSearchController extends AbstractStaffSearchPageController
{
	//CMS Page
	...
	public String get(final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute("sabmCustomerSearchForm", new SABMCustomerSearchForm());
	...
	@RequireHardLogIn
	public String doCustomerSearch(final SABMCustomerSearchForm form, final BindingResult bindingResult, final Model model)
			throws CMSItemNotFoundException
	{
	...
	public String backToCustomerSearchResults(final Model model) throws CMSItemNotFoundException
	{
		...
		final SABMCustomerSearchForm form = getSessionService().getAttribute(SESSION_CUSTOMER_SEARCH_FORM);
	 ...
	 */
	protected SearchQueryData getSearchQuery(final SABMCustomerSearchForm form)
	{
		validateParameterNotNull(form, "SABMCustomerSearchForm cannot be null");
		final SearchQueryData searchQueryData = new SearchQueryData();
		String queryValue = SabmFacadesConstants.CUSTOMER_NAM_ASC;
