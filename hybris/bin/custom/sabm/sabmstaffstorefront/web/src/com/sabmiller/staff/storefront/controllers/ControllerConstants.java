 ...
 *
 */
package com.sabmiller.staff.storefront.controllers;
	...
	interface Views
	{
		...
		interface Pages
		{
			interface Account
			{
				...
				String AccountStaffLoginPage = "pages/account/staffAccountLoginPage";
				String AccountStaffLogoutPage = "pages/account/staffAccountLogoutPage";
