			...
			<div class="item_container_holder">
				...
				<div class="item_container">
					...
					<div class="payment_details_right_col saved-payment-list">
						<h2>
							<spring:theme code="mobile.multi.checkout.selectExistingCard" text="Choose from existing Payment Details"/>
						</h2>
						<c:forEach items="${paymentInfos}" var="paymentInfo">
							<div class="saved-payment-list-entry">
								...
								<form:form action="${request.contextPath}/checkout/multi/payment-method/remove" method="POST" class="remove-payment-item-form">
					...
					<div class="payment_details_left_col">
						...
						<div class="save_payment_details">
							<span class="clear_fix">
								<button data-theme="c" class="form submit_silentOrderPostForm" tabindex="19">
