...
import com.sabmiller.storefront.util.CSRFTokenManager;
import com.sabmiller.storefront.web.view.UiExperienceViewResolver;
...
public class UiThemeResourceBeforeViewHandler implements BeforeViewHandler
{
	...
	public void beforeView(final HttpServletRequest request, final HttpServletResponse response, final ModelAndView modelAndView)
	{
		...
		modelAndView.addObject("staticHostPath", siteConfigService.getString("statics.host.path", ""));
		modelAndView.addObject("staticsVersion", siteConfigService.getString("statics.version", ""));
		modelAndView.addObject("baseUrl", siteConfigService.getString("website.sabmStore.https", ""));
		modelAndView.addObject("commonStaticsContextPath", siteConfigService.getString("common.statics.context.path", ""));
		modelAndView.addObject("sharedStaticsContextPath", siteConfigService.getString("shared.statics.context.path", ""));
		modelAndView.addObject("siteStaticsContextPath", siteConfigService.getString("site.statics.context.path", ""));
		...
		modelAndView.addObject("useMinified", siteConfigService.getBoolean("statics.use.minified", false));
