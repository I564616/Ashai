...
import com.sabmiller.storefront.filters.StorefrontFilter;
...
public class StoreSessionController extends AbstractController
{
	...
	public String selectLanguage(@RequestParam("code") final String isoCode, final HttpServletRequest request)
	{
		...
		storeSessionFacade.setCurrentLanguage(XSSFilterUtil.filter(isoCode));
	...
	public String selectCurrency(@RequestParam("code") final String isoCode, final HttpServletRequest request)
	{
		...
		storeSessionFacade.setCurrentCurrency(XSSFilterUtil.filter(isoCode));
	...
	{ RequestMethod.GET, RequestMethod.POST })
	public String selectUiExperienceLevel(@RequestParam("level") String uiExperienceLevelString,
			final HttpServletRequest request)
	{
		uiExperienceLevelString = XSSFilterUtil.filter(uiExperienceLevelString);
