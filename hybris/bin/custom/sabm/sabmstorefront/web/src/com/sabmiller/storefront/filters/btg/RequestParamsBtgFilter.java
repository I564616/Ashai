 ...
 * de.hybris.platform.btg.events.RequestParametersUsedBTGRuleDataEvent;
 * 
 ...
 *//**
	 ...
	 *//*
		 ...
		 * RequestParametersUsedBTGRuleDataEvent result = null; final Map<String, String[]> params =
		 * request.getParameterMap(); if (!MapUtils.isEmpty(params)) { result = new
		 * RequestParametersUsedBTGRuleDataEvent(params); } return result; }
		 * 
