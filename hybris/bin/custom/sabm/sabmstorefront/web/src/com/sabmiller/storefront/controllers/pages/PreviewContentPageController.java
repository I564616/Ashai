...
public class PreviewContentPageController extends SabmAbstractPageController
{
	...
	public String get(@RequestParam(value = "uid") final String cmsPageUid, final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute("pageType", SABMWebConstants.PageType.PREVIEW_CONTENT.name());
