 ...
 * 
 * import de.hybris.platform.acceleratorstorefrontcommons.controllers.pages.AbstractPageController; import
 * de.hybris.platform.btg.events.ContentPageVisitedBTGRuleDataEvent; import
 ...
 *//**
	 ...
	 *//*
		 * public class BtgPageVisitedPublisherBeforeViewHandler implements BeforeViewHandler { private static final
		 * Logger LOG = Logger.getLogger(BtgPageVisitedPublisherBeforeViewHandler.class);
		 * 
		 * @Resource(name = "eventService") private EventService eventService;
		 * 
		 * @Override public void beforeView(final HttpServletRequest request, final HttpServletResponse response, final
		 * ModelAndView modelAndView) { final AbstractPageModel page = (AbstractPageModel)
		 * modelAndView.getModel().get(AbstractPageController.CMS_PAGE_MODEL); if (page != null && page.getPk() != null) {
		 * try { eventService.publishEvent(new ContentPageVisitedBTGRuleDataEvent(page.getPk().getLongValueAsString())); }
