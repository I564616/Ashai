...
<div data-theme="c">
	...
	<c:if test="${not empty searchPageData.results}">
		...
		<nav:pagination searchPageData="${searchPageData}" searchUrl="/your-business/orders?sort=${searchPageData.pagination.sort}" msgKey="text.account.orderHistory.mobile.page"/>
		<ul data-role="listview" data-inset="true" data-theme="d" data-dividertheme="d">
			<c:forEach items="${searchPageData.results}" var="order">
				<li>
					<c:url value="/your-business/order/${order.code}" var="myAccountOrderDetailsUrl"/>
