...
<ul class="hero-banner-rotating-images" data-timeout="${component.timeout}">
    ...
    <li data-colortreatment="${banner.colorTreatment}" data-textposition="${banner.textAlignment.code}">
            <div class="image-wrapper">
                <c:if test="${not empty banner.urlLink}">
                	<c:set var="bannerUrlLink" value="${banner.urlLink}?&userpk=${user.gaUid}" />
                	<a href="${bannerUrlLink}" onclick="rm.header.carouselBannerClick(this);"
                	   id="carouselBannerTag"
                	   class="carouselBannerTag"
                	   data-url="${bannerUrlLink}"
                	   data-id="${banner.desktopHeroImage.code}"
                	   data-name="${banner.desktopHeroImage.code}"
                	   data-altText="${banner.desktopHeroImage.altText}"
                	   data-type="${banner.desktopHeroImage.code}"
                	   data-position="${status.index}"
                	   data-isExternal="${banner.external}"
