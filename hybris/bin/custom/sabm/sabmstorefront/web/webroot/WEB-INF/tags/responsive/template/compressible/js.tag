...
<script type="text/javascript" src="${commonResourcePath}/js/jquery-ui-1.12.0-rc.1.min.js"></script>
...
<%--HTML cut required js --%>
<script type="text/javascript" src="${commonResourcePath}/js/libs/respond.min.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/main.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/plugins.js"></script>
<script type="text/javascript" src="${commonResourcePath}/js/src.js"></script>
