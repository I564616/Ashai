							...
							<div class="ui-grid-a" data-theme="b" data-role="content">
								<div class="ui-block-a" style="width: 100%">
									<ul>
										...
										<li>
											<fieldset class="ui-grid-a">
												<div class="ui-block-a">
													<c:url value="/your-business/remove-address/${address.id}" var="removeAddressFormAction" />
												...
												<div class="ui-block-b">
													<c:choose>
															<c:when test="${not address.defaultAddress}">
																	<c:url value="/your-business/set-default-address/${address.id}" var="setDefaultAddressUrl" />
										...
										<li>
											<c:url value="/your-business/edit-address/${address.id}" var="editAddressUrl" />
