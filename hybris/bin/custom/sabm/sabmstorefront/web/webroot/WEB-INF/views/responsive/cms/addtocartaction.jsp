	...
	<c:choose>
		...
		<c:otherwise>
			<div class="row summary-btns">
				<div class="col-md-6">
					<ycommerce:testId code="addToTemplateButton">
						<button id="addToTemplateButton" type="${buttonType}" class="btn btn-secondary btn-block" disabled="disabled">
							<spring:theme code="basket.add.to.template"/>
				   		</button>
				 	</ycommerce:testId>
				</div>
				<div class="col-md-6">
