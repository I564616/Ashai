...
<%-- JS configuration --%>
	<script type="text/javascript">
		...
		var ACC = { config: {} };
			...
			ACC.config.commonResourcePath = "${staticHostPath}${commonResourcePath}";
			...
			ACC.outOfStock ='<spring:theme code="basket.remove.OOS" />';
			ACC.deliveryPackDate ='<spring:theme code="basket.remove.deliveryPackDate" />';
			ACC.deliveryPackDateOrderHistory ='<spring:theme code="basket.home.order.products.notadded.tocart" />';
			ACC.deliveryDatePackType = '${deliveryDatePackType}'.toUpperCase();
