			...
			<div class="paymentItem">
				...
				<div class="buttons">
					<c:if test="${not paymentInfo.defaultPaymentInfo}">
						<c:url value="/your-business/set-default-payment-details" var="setDefaultPaymentActionUrl"/>
					...
					<c:url value="/your-business/remove-payment-method" var="removePaymentActionUrl"/>
