...
<%@ taglib prefix="cms" uri="http://hybris.com/tld/cmstags"%>
			...
			<c:url value="/your-business/update-profile" var="updateProfileUrl" />
			<form:form action="${updateProfileUrl}" method="post" modelAttribute="updateProfileForm" data-ajax="false">
				<common:errors />
					...
					<li>
						<fieldset class="ui-grid-a doubleButton">
							<div class="ui-block-a">
								<c:url value="/your-business/profile" var="profileUrl" />
