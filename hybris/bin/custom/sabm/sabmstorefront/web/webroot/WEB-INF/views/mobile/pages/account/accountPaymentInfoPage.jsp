			...
			<ul class="mFormList">
				<li>
					<fieldset class="ui-grid-a doubleButton">
						<div class="ui-block-a">
							<c:url value="/your-business/remove-payment-method" var="removePaymentCardFormAction"/>
						...
						<div class="ui-block-b">
							<c:if test="${not paymentInfo.defaultPaymentInfo}">
								<c:url value="/your-business/set-default-payment-details" var="setDefaultPaymentDetailsFormAction"/>
