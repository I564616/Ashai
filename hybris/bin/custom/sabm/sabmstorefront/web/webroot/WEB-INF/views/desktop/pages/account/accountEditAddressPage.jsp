...
<div class="span-24">
	<div class="span-20 last">
		<div class="accountContentPane clearfix">
			...
			<address:addressFormSelector supportedCountries="${countries}" regions="${regions}" cancelUrl="/your-business/address-book"/>
			<address:suggestedAddresses selectedAddressUrl="/your-business/select-suggested-address"/>
		</div>
	</div>
</div>