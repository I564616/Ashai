 ...
 */
public class SABMTmdNextInQueueSMSContextDataPopulator implements Populator<Map, SABMTmdNextInQueueSMSContextData> {
    /**
     ...
     */
    @Override
    public void populate(Map source, SABMTmdNextInQueueSMSContextData target) throws ConversionException {
