 ...
 */
public class SABMTmdPassETASMSContextDataPopulator implements Populator<Map, SABMTmdPassETASMSContextData> {
    /**
     ...
     */
    @Override
    public void populate(Map source, SABMTmdPassETASMSContextData target) throws ConversionException {
