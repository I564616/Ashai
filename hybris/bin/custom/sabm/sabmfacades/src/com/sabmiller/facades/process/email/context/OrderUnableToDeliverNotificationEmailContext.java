 ...
 *
 */
public class OrderUnableToDeliverNotificationEmailContext
		extends AbstractEmailContext<OrderUnableToDeliverNotificationEmailProcessModel>
{
	...
	@Override
	public void init(final OrderUnableToDeliverNotificationEmailProcessModel businessProcessModel,
	...
	@Override
	protected BaseSiteModel getSite(final OrderUnableToDeliverNotificationEmailProcessModel businessProcessModel)
	{
	...
	@Override
	protected CustomerModel getCustomer(final OrderUnableToDeliverNotificationEmailProcessModel businessProcessModel)
	{
		return businessProcessModel.getCustomer();
	}

	@Override
	protected LanguageModel getEmailLanguage(final OrderUnableToDeliverNotificationEmailProcessModel businessProcessModel)
	{
