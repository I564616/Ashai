 ...
 */
public class ForgottenPasswordEmailContext extends ApbCustomerEmailContext
{
	private int expiresInMinutes = 30;
	private String token;

	/*
	 * private String payerEmail; private String customerAccountName; private boolean payerAccess; private boolean
	 * orderAccess;
	 */
	...
	public void init(final StoreFrontCustomerProcessModel storeFrontCustomerProcessModel, final EmailPageModel emailPageModel)
	{
		...
		if (storeFrontCustomerProcessModel instanceof ForgottenPasswordProcessModel)
		{
			...
			put("orderAccess", ((ForgottenPasswordProcessModel) storeFrontCustomerProcessModel).getOrderAccess());
			put("payAccess", ((ForgottenPasswordProcessModel) storeFrontCustomerProcessModel).getPayAccess());
			put("payerEmail", ((ForgottenPasswordProcessModel) storeFrontCustomerProcessModel).getPayerEmail());
			put("customerAccountName", ((ForgottenPasswordProcessModel) storeFrontCustomerProcessModel).getCustomerAccountName());
