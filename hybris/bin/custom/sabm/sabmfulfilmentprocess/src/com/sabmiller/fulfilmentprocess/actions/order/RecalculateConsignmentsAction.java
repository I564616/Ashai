...
public class RecalculateConsignmentsAction extends AbstractProceduralAction<OrderProcessModel>
{
	private static final Logger LOG = Logger.getLogger(RecalculateConsignmentsAction.class);
	...
	public void executeAction(final OrderProcessModel process)
	{
		...
		getModelService().saveAll(orderModel.getConsignments());
