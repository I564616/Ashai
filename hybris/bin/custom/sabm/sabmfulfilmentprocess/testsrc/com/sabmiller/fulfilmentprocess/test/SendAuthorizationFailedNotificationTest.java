...
import com.sabmiller.fulfilmentprocess.actions.order.SendAuthorizationFailedNotificationAction;
...
public class SendAuthorizationFailedNotificationTest
{
	...
	/**
	 * Test method for
	 * {@link com.sabmiller.fulfilmentprocess.actions.order.SendOrderPlacedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	...
	public void testExecuteActionOrderProcessModel()
	{
		...
		Mockito.verify(eventService).publishEvent(MockitoHamcrest.argThat(new BaseMatcher<FraudErrorEvent>()
		{
			@Override
