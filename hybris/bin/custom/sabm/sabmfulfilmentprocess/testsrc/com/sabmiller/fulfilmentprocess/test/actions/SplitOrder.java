 ...
 *
 */
package com.sabmiller.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(SabmFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(SabmFulfilmentProcessConstants.PARENT_PROCESS);
