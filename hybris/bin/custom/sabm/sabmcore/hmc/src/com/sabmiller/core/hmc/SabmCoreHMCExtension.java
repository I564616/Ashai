 ...
 *
 */
package com.sabmiller.core.hmc;
...
/**
 * Provides necessary meta information about the sabmcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class SabmCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(SabmCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "com.sabmiller.core.hmc.locales";
