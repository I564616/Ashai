...
public class DealConditionGroupWithOldCreationTimeItemProvider extends AbstractDealsItemRemovalProvider<DealConditionGroupModel> {
    @Override
    public List<DealConditionGroupModel> getItemsToRemoved(OldSABMDealsRemovalCronJobModel oldSABMDealsRemovalCronJobModel, DealRemovalContext context) {
        return getDealsService().getDealConditionGroup(context.getDate(), context.getBatchSize());
    }
