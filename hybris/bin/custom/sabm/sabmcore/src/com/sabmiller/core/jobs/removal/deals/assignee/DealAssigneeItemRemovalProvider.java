...
public class DealAssigneeItemRemovalProvider extends AbstractDealsItemRemovalProvider<DealAssigneeModel> {
    @Override
    public List<DealAssigneeModel> getItemsToRemoved(OldSABMDealsRemovalCronJobModel oldSABMDealsRemovalCronJobModel, DealRemovalContext context) {
        return getDealsService().getDealAssignee(context.getDate(), context.getBatchSize());
    }
