 ...
 */
public class CustomerNameProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider
{
	/** The Provider */
			...
			final IndexedProperty indexedProperty)
	{
		...
		addFieldValues(fieldValues, indexedProperty, language, b2bunit.getName());
		return fieldValues;
	}
