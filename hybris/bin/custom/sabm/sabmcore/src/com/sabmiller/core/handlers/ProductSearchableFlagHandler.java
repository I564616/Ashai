...
public class ProductSearchableFlagHandler implements DynamicAttributeHandler<Boolean, ProductModel>
{
	private SabmProductService productService;

	/**
	 * Return if product is searchable on site
	 *
	 * @param product
	 *           the product
	 * @return true if product is searchable on site
	 */
	@Override
	public Boolean get(final ProductModel product)
	{
		return product instanceof SABMAlcoholVariantProductEANModel
				&& productService.isProductSearchable((SABMAlcoholVariantProductEANModel) product);
	}
	...
	{
		throw new UnsupportedOperationException("Set of dynamic attribute 'searchable' of Product is disabled!");
	}
