 ...
 *
 */
public class SabmOrderEnquiryPopulator implements Populator<AbstractBusinessEnquiryData, SabmOrderEnquiryData>
{
	/*
	 * (non-Javadoc)
	 *
	 ...
	 */
	@Override
	public void populate(final AbstractBusinessEnquiryData source, final SabmOrderEnquiryData target) throws ConversionException
	{
		...
		// specific to Order Enquiry
		final Map<String, Object> data = source.getData();

		if ((String) data.get("ordernumber") == null)
		{
			target.setOrderNumber(StringUtils.EMPTY);
		}
		else
		{
