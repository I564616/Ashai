 ...
 */
public class CustomerAddressRegionProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider
{
	/** The Provider */
	 ...
	 * @return RegionModel
	 */
	protected RegionModel getRegion(final B2BUnitModel b2bUnitModel)
	{
