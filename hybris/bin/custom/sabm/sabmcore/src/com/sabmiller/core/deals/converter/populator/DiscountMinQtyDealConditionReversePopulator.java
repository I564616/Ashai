...
public class DiscountMinQtyDealConditionReversePopulator implements Populator<DealItem, DealModel>
{
	...
	public void populate(final DealItem source, final DealModel target) throws ConversionException
	{
		...
		minQtyDealConditionModel.setQuantity(source.getMinimumQuantity());
