...
public class CartDealConditionWithEmptyDealItemProvider extends AbstractDealsItemRemovalProvider<CartDealConditionModel> {
    @Override
    public List<CartDealConditionModel> getItemsToRemoved(OldSABMDealsRemovalCronJobModel oldSABMDealsRemovalCronJobModel, DealRemovalContext context) {
        return getCleanupDao().getItemsWithEmptyReference(CartDealConditionModel.class,CartDealConditionModel.DEAL,context.getBatchSize());
    }
