 ...
 *
 */
public class OrderingStatusProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider
{
			...
			final IndexedProperty indexedProperty)
	{
		...
		final String businessUnitStatus = b2bUnitService.getOrderingStatus(b2bunit, ordersAfterDate.toDate());
