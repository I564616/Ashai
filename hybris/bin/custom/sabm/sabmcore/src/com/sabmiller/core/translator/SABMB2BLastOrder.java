 ...
 *
 */
public class SABMB2BLastOrder extends SABMAbstracB2BCustomerTranslator
{
	/** The Constant LOG. */
	private static final Logger LOG = LoggerFactory.getLogger(SABMB2BLastOrder.class);
	...
	public String performExport(final Item item) throws ImpExException
	{
		...
		if (isValidAndSetup(item) && b2bOrderService != null)
		{
			...
			final OrderModel lastOrder = b2bOrderService.getLastOrderByCustomer(user);
			if (lastOrder != null)
			{
