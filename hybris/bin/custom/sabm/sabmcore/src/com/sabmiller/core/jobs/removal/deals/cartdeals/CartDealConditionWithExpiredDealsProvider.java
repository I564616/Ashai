...
public class CartDealConditionWithExpiredDealsProvider extends AbstractDealsItemRemovalProvider<CartDealConditionModel> {
    @Override
    public List<CartDealConditionModel> getItemsToRemoved(OldSABMDealsRemovalCronJobModel oldSABMDealsRemovalCronJobModel, DealRemovalContext context) {
        return getDealsService().getCartDealConditionForExpiredDeals(context.getDate(), context.getBatchSize());
    }
