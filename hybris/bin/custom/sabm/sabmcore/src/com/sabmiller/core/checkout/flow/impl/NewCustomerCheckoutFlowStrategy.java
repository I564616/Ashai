...
package com.sabmiller.core.checkout.flow.impl;
...
@Deprecated
public class NewCustomerCheckoutFlowStrategy extends B2BCheckoutFlowStrategy
{
	private static final Logger LOG = Logger.getLogger(NewCustomerCheckoutFlowStrategy.class);

	private UserService userService;
	private CustomerAccountService customerAccountService;
	private B2BCheckoutFlowStrategy newCustomerStrategy;
...
/**
	...
	protected B2BCheckoutFlowStrategy getNewCustomerStrategy()
	{
		return newCustomerStrategy;
	}

	@Required
	public void setNewCustomerStrategy(final B2BCheckoutFlowStrategy newCustomerStrategy)
	{
