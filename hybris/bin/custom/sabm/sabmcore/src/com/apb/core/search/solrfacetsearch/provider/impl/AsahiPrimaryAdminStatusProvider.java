 ...
 *
 */
public class AsahiPrimaryAdminStatusProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider
{
			...
			final IndexedProperty indexedProperty)
	{
		...
		final String businessUnitStatus = b2bUnitService.findB2BUnitStatus(b2bunit.getUid());
