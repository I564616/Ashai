 ...
 *
 */
public class AsahiSendUsersToSFJob extends AbstractJobPerformable<CronJobModel>
{
	private static final Logger LOGGER = LogManager.getLogger(AsahiSendUsersToSFJob.class);
	...
	{
		final List<B2BCustomerModel> customersSendToSF = sabmB2BCustomerService.getALBCustomersToSFList();
		LOGGER.info("ALB users count for delta load:"+customersSendToSF.size());
