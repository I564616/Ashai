 ...
 */
package com.apb.core.actions.quote;

import static com.apb.core.constants.ApbCoreConstants.QUOTE_USER_TYPE;
...
{
	private static final Logger LOG = LoggerFactory.getLogger(QuoteBuyerSubmitAction.class);
