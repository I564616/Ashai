...
/**
 * AsahiCustomerNameProvider
 */
public class AsahiCustomerNameProvider extends AbstractPropertyFieldValueProvider implements FieldValueProvider
{
	/** The Provider */
			...
			final IndexedProperty indexedProperty)
	{
		...
		addFieldValues(fieldValues, indexedProperty, language, b2bunit.getLocName());
		return fieldValues;
	}
