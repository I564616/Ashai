...
/**
 * AsahiAuthorizationIdAttributeHandler implementation of {@link DynamicAttributeHandler}
 */
public class AsahiAuthorizationIdAttributeHandler implements DynamicAttributeHandler<String, AbstractOrderModel>
{
	private final static Logger LOG = LoggerFactory.getLogger("AsahiAuthorizationIdAttributeHandler");
		...
		if (CollectionUtils.isNotEmpty(paymentTransactionModels))
		{
			...
			if (CollectionUtils.isNotEmpty(paymentTransactionEntryModels))
			{
				...
				if (paymentTransactionEntryModel instanceof AsahiPaymentTransactionEntryModel)
				{
					...
					return ((AsahiPaymentTransactionEntryModel) paymentTransactionEntryModel).getAuthorizationId();
				}
			}
		}
