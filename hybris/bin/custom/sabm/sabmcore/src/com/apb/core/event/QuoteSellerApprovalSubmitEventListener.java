...
import static com.apb.core.constants.ApbCoreConstants.QUOTE_SELLER_APPROVER_PROCESS;
...
public class QuoteSellerApprovalSubmitEventListener extends AbstractEventListener<QuoteSellerApprovalSubmitEvent>
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(QuoteSellerApprovalSubmitEventListener.class);
