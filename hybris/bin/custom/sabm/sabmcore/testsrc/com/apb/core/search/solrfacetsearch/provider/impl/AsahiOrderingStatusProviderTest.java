...
public class AsahiOrderingStatusProviderTest
{
	@Spy
	@InjectMocks
	private final AsahiOrderingStatusProvider asahiOrderingStatusProvider = new AsahiOrderingStatusProvider();
	...
	public void setup()
	{
		Mockito.lenient().when(b2bUnitService.findB2BUnitStatus("b2bId")).thenReturn("status");
		when(b2bUnitService.getAsahiOrderingStatus(Mockito.any(), Mockito.any())).thenReturn("Order Status");
	...
	public void getFieldValueTest() throws FieldValueProviderException
	{
		...
		assertEquals(1, asahiOrderingStatusProvider.getFieldValues(indexConfig, indexedProperty, b2bunit).size());
	}
	...
	public void getFieldValueExceptionTest() throws FieldValueProviderException
	{
		...
		asahiOrderingStatusProvider.getFieldValues(indexConfig, indexedProperty, model);
