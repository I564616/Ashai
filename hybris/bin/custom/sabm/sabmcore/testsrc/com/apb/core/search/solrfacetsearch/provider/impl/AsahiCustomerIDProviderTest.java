...
public class AsahiCustomerIDProviderTest
{
	@Spy
	@InjectMocks
	private final AsahiCustomerIDProvider asahiCustomerIDProvider = new AsahiCustomerIDProvider();
	...
	public void getFieldValueTest() throws FieldValueProviderException
	{
		...
		assertEquals(1, asahiCustomerIDProvider.getFieldValues(indexConfig, indexedProperty, b2bunit).size());
	}
	...
	public void getFieldValueExceptionTest() throws FieldValueProviderException
	{
		...
		asahiCustomerIDProvider.getFieldValues(indexConfig, indexedProperty, model);
