...
public class AsahiCustomerNameProviderTest
{
	@Spy
	@InjectMocks
	private final AsahiCustomerNameProvider asahiCustomerNameProvider = new AsahiCustomerNameProvider();
	...
	public void setup()
	{
		Mockito.lenient().when(b2bunit.getName()).thenReturn("b2bUnitname");
	...
	public void getFieldValueTest() throws FieldValueProviderException
	{
		...
		assertEquals(1, asahiCustomerNameProvider.getFieldValues(indexConfig, indexedProperty, b2bunit).size());
	}
	...
	public void getFieldValueExceptionTest() throws FieldValueProviderException
	{
		...
		asahiCustomerNameProvider.getFieldValues(indexConfig, indexedProperty, model);
