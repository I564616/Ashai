...
public class AsahiPrimaryAdminStatusProviderTest
{
	@Spy
	@InjectMocks
	private final AsahiPrimaryAdminStatusProvider asahiPrimaryAdminStatus = new AsahiPrimaryAdminStatusProvider();
	...
	public void setup()
	{
		when(b2bunit.getUid()).thenReturn("b2bId");
		when(b2bUnitService.findB2BUnitStatus("b2bId")).thenReturn("status");
	...
	public void getFieldValueTest() throws FieldValueProviderException
	{
		...
		assertEquals(1, asahiPrimaryAdminStatus.getFieldValues(indexConfig, indexedProperty, b2bunit).size());
	}
	...
	public void getFieldValueExceptionTest() throws FieldValueProviderException
	{
		...
		asahiPrimaryAdminStatus.getFieldValues(indexConfig, indexedProperty, model);
