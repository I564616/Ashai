...
public class GuestOrderController extends ApbAbstractPageController
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(GuestOrderController.class);

	@Resource(name = "orderFacade")
	private OrderFacade orderFacade;

	@GetMapping("/order/" + ORDER_GUID_PATH_VARIABLE_PATTERN)
			...
			throws CMSItemNotFoundException
	{
		try
		{
			...
			if((getContentPageForLabelOrId(ORDER_DETAIL_CMS_PAGE)).getBackgroundImage() != null)
				model.addAttribute("media", (getContentPageForLabelOrId(ORDER_DETAIL_CMS_PAGE)).getBackgroundImage().getURL());
		...
		catch (final IllegalArgumentException ae)
		{
			...
			{
				LOG.debug("IllegalArgumentException occurred...", ae);
			}
