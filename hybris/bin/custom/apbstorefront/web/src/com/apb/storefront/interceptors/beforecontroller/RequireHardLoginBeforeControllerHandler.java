...
import com.apb.storefront.security.evaluator.impl.RequireHardLoginEvaluator;
...
{
	private static final Logger LOG = LoggerFactory.getLogger(RequireHardLoginBeforeControllerHandler.class);
