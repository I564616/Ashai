...
import com.apb.storefront.web.wrappers.UrlEncodeHttpRequestWrapper;
...
{
	private static final Logger LOG = LoggerFactory.getLogger(UrlEncoderFilter.class.getName());
