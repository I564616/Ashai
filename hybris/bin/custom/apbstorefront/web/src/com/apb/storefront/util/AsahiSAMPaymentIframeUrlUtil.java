 ...
 */
public class AsahiSAMPaymentIframeUrlUtil
{
	...
	private static final String SECRET_KEY = "asahi.payment.target.shared.secret.key.sam.";
	private static final String CURRENCY_ID = "AUD";
	private static final String DEFAULT_ALGO = "HmacMD5";

	private static final String ACCOUNT_ID = "asahi.payment.target.account.id.sam.";
	private static final String TARGET_URL = "asahi.payment.target.url.sam.";
	private static final String TARGET_QUERY_PARAM = "asahi.payment.target.query.param.sam.";
	...
	private static final String CREDIT_CARD_EXTERNAL_CSS_URL = "credit.card.iframe.external.css.url.sam.";
