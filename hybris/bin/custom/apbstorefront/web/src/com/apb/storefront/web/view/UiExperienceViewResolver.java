 ...
 */
package com.apb.storefront.web.view;
...
{
	private static final Logger LOG = LoggerFactory.getLogger(UiExperienceViewResolver.class);

	private static final String ADDON = "addon:";
	private UiExperienceService uiExperienceService;
	protected Map<UiExperienceLevel, String> uiExperienceViewPrefix;
	...
	public String getViewName(final UiExperienceLevel uiExperienceLevel, final String viewName)
	{
		...
		if (prefix != null)
		{
			if (viewName.startsWith(ApbAbstractPageController.PAGE_ROOT + ADDON))
			{
				properViewName = viewName.replace(ApbAbstractPageController.PAGE_ROOT + ADDON, ADDON); // ...pages/addon:/<extension-name>/.../<component-view>....->....addon:/<extension-name>/.../<component-view>
			}
