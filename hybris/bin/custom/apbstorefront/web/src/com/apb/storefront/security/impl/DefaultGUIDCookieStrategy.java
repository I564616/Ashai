...
import com.apb.storefront.interceptors.beforecontroller.RequireHardLoginBeforeControllerHandler;
...
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultGUIDCookieStrategy.class);
