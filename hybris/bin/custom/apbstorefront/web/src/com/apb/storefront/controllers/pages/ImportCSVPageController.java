...
public class ImportCSVPageController extends ApbAbstractPageController
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(ImportCSVPageController.class);
	...
	@GetMapping(SAVED_CART_PATH_SEGMENT)
	@RequireHardLogIn
	public String savedCartImport(final Model model) throws CMSItemNotFoundException
	{
		...
		if((getContentPageForLabelOrId(IMPORT_CSV_SAVED_CART_CMS_PAGE)).getBackgroundImage() != null)
			model.addAttribute("media", (getContentPageForLabelOrId(IMPORT_CSV_SAVED_CART_CMS_PAGE)).getBackgroundImage().getURL());
	...
	@ResponseBody
	@PostMapping(SAVED_CART_PATH_SEGMENT)
	@RequireHardLogIn
