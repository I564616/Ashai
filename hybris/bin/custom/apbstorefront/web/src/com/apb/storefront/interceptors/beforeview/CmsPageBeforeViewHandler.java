...
import com.apb.storefront.filters.cms.CMSSiteFilter;
...
{
	private static final Logger LOG = LoggerFactory.getLogger(CmsPageBeforeViewHandler.class);
	...
	protected AbstractPageModel updateCmsPageInModelAndView(final HttpServletRequest request, final ModelAndView modelAndView)
	{
		...
		final AbstractPageModel requestedPage = (AbstractPageModel) modelAndView.getModel().get(
				ApbAbstractPageController.CMS_PAGE_MODEL);
		if (requestedPage != null)
		{
			...
			if (previewPage != null && !previewPage.equals(requestedPage))
			{
				...
				else
				{
					...
					modelAndView.addObject(ApbAbstractPageController.CMS_PAGE_MODEL, previewPage);
	...
	protected String getViewForPage(final AbstractPageModel page)
	{
		if (page != null)
		{
			...
			if (masterTemplate != null)
			{
				...
				{
					return ApbAbstractPageController.PAGE_ROOT + targetPage;
				}
			}
		}
		return null;
