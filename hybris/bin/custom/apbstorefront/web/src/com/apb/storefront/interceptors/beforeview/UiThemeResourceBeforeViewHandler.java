...
import com.apb.storefront.web.view.UiExperienceViewResolver;
...
public class UiThemeResourceBeforeViewHandler implements BeforeViewHandler
{
	...
	private static final Logger LOG = LoggerFactory.getLogger(UiThemeResourceBeforeViewHandler.class);
	...
	public void beforeView(final HttpServletRequest request, final HttpServletResponse response, final ModelAndView modelAndView)
	{
		...
		modelAndView.addObject(ApbStoreFrontContants.EXIST_SUPERUSER, checkSuperUser());
