...
import com.apb.storefront.filters.StorefrontFilter;
...
public class StoreSessionController extends AbstractController
{
			...
			final HttpServletRequest request)
	{
		...
		else
		{
			...
			{
				LOG.warn("Unknown UiExperience level [" + ApbXSSEncoderUtil.encodeValue(uiExperienceLevelString) + "] available values are: "
