 ...
 */
package com.apb.storefront.web.theme;
...
import com.apb.storefront.util.SiteThemeResolverUtils;
...
public class StorefrontResourceBundleSource implements ThemeSource, ResourceLoaderAware, MessageSource
{
	...
	protected Theme computeThemeForGivenKey(String themeName)
	{
		...
		if(addOnNames.contains("apbcommorgaddon"))
		{
			addOnNames.remove("apbcommorgaddon");
			addOnNames.add("apbcommorgaddon");
		}
