					...
					<div class="checkout-shipping">
						...
						<div class="checkout-indent">
							...
							<c:if test="${deliveryInfoData.deliveryCutOff eq 'BeforeCutOff'}">
									...
									<p><spring:theme code="delivery.message.before.cutoff"
                                                                  arguments="${deliveryInfoData.cutOffDate},${deliveryInfoData.deliveryDays},${deliveryInfoData.maxDeliveryDays}"/></p>
                             </c:if>
                             <c:if test="${deliveryInfoData.deliveryCutOff eq 'AfterCutOff'}">
                           		    <p><spring:theme code="delivery.message.after.cutoff"
                                                                  arguments="${deliveryInfoData.deliveryDays},${deliveryInfoData.maxDeliveryDays}"/></p>
							</c:if>
							</c:if>
							
							 <c:if test="${not deliveryInfoData.disableDeferredDelivery}">
                           		 <!--  <p> Deferred delivery code here</p> -->
							</c:if>
