<%@ taglib prefix="c" uri="jakarta.tags.core" %>
    ...
    <c:if test="${showLiveChat ==true}">
        ...
        <input type="hidden" id="livechatMiawSiteNameALB" value="${livechatMiawSiteNameALB}" />

        <c:if test="${isBDECustomer}">
            <input type="hidden" id="asahiStaffEmail" value="${asahiStaffEmail}" />
        </c:if>

        <script type="text/javascript" src="${staticHostPath}/storefront/_ui/responsive/common/js/livechat.js"></script>
