...
<template:page pageTitle="${pageTitle}">
	...
	<div class="search-empty">
		<div class="headline">
		<!--  Adding double line to test url for Image on -->
		<div id = "testbackgroundImage" value = "${backgroundImage}">
		<img  data-src="${backgroundImage}" /></div>
            <spring:theme code="search.no.results.start"/><span class="search-result-text"><spring:theme code="search.no.results.mid" arguments="${searchPageData.freeTextSearch}"/></span><spring:theme code="search.no.results.end"/>
		</div>
