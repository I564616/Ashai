...
"cartError" : "<spring:theme code='${errorMsg}' />",

"cartAnalyticsData":{"cartCode" : "${cartCode}","productPostPrice":"${entry.basePrice.value}","productName":"<c:out value='${product.name}' />","productCode":"${entry.product.code}"}
,
