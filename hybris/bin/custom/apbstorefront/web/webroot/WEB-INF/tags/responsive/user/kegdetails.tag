		...
		<div class="col-xs-9 col-md-3">
			...
			<div class="addtocart-component">
				<div class="qty-selector input-group js-keg-qty-selector">
					...
					<form:input type="hidden" maxlength="3"	 path="apbKegReturnKegSizForm[${status.index}].kegSize"
						/> 
					<form:input type="text" maxlength="3" style="display: inline"
						class="form-control js-qty-selector-input" size="1"
						data-max="999" data-min="0" path="apbKegReturnKegSizForm[${status.index}].kegQuantity"
