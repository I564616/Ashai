...
<p class="account-orderhistory-label"><label:message messageCode="order.template.list.heading.apb"/></p>
 ...
 <div class="account-orderhistory-pagination">
            <nav:paginationwithdisplay top="true" msgKey="text.account.savedCarts.page" showCurrentPageInfo="true"
            ...
            <table class="responsive-table">
                <thead>
                    <tr class="responsive-table-head hidden-xs">
                        ...
                        <th><spring:theme code="text.account.savedCart.createdBy" /></th>
                        <th><spring:theme code="text.account.savedCart.dateCreated" /></th>
