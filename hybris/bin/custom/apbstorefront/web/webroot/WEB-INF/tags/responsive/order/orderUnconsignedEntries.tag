    ...
    <ul class="item__list">
        <li class="hidden-xs hidden-sm">
            <ul class="item__list--header">
                ...
                <c:choose>
		            <c:when test="${cmsSite.uid eq 'sga'}"> <li class="item__quantity"><spring:theme code="basket.page.qty.sga"/></li></c:when>
		            <c:otherwise> <li class="item__quantity"><spring:theme code="basket.page.qty"/></li></c:otherwise>
            	</c:choose>
