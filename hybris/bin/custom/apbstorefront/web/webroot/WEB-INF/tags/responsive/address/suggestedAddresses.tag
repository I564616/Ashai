...
<spring:url value="{url}" var="selectSuggestedAddressUrl" htmlEscape="false">
    <spring:param name="url" value="${selectedAddressUrl}"/>
</spring:url>

<div class="display-none" id="popup_suggested_delivery_addresses_form">
