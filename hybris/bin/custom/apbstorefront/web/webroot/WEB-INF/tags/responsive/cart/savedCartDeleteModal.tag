...
<div class="hidden">
	<div id="popup_confirm_savedcart_delete_${fn:escapeXml(savedCart.code)}"
		...
		data-savedCartInfo="{name:${fn:escapeXml(savedCart.name)}, id:${fn:escapeXml(savedCart.code)}, numberOfProducts:${savedCart.totalItems}">
		<p>
		...
		<div class="modal-details row">
			...
			<span class="col-xs-6"><b>${fn:length(savedCartData.templateEntry)}</b></span>
		</div>
