...
<br>
<p>
    <spring:theme code="sga.user.register.updated.notification" />
</p>

<div class="row btn-register-request">
    <div class="col-md-3 col-sm-6">
        <div class="form-actions clearfix">
            <button type="button" class="btn btn-default btn-block btn-vd-primary sga-registration-link"><spring:theme code="sga.user.registration.link" /></button>
        </div>
    </div>
</div>