...
ACC.navigation = {
    ...
    myAccountNavigation: function(){
        ...
        navClose += '<button type="button" class="js-toggle-sm-navigation btn"><img class="menu-close-icon" src="' + ACC.config.commonResourcePath + '/images/close_white.svg"  /></button>';
        navClose += '</div>';
    ...
    homepagePromoSlotsCheck: function(){
		...
		for (i = 1; i < 5; i++) {
			if ($("#slot-margin" + i).find(".content").is(':empty')) {
				...
				$("#slot-margin" + i).find(".content").css("margin","10px 5px");
				$("#slot-margin" + i).css("padding","30px 30px");
			}
		}
