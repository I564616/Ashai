...
//
//            if ($(window).width() > 767) {
//				$('.order-history-mobile').find('input').attr("disabled","disabled");
//            }
//
//            else if ($(window).width() <= 767) {
//				$('.desktop-viw').find('input').attr("disabled","disabled");
//            }
//
//        }
    },
...
//	if ($(window).width() > 767) {
//		$('.order-history-mobile').find('input').attr("disabled", "disabled");
//		$('.desktop-viw').find('input').removeAttr("disabled");
//		$('.desktop-viw').find('.js-qty-selector-input-disabled').attr("disabled", "disabled");
//	} else if ($(window).width() <= 767) {
//		$('.desktop-viw').find('input').attr("disabled", "disabled");
//		$('.order-history-mobile').find('input').removeAttr("disabled");
//		$('.order-history-mobile').find('.js-qty-selector-input-disabled').attr("disabled", "disabled");
//	}
//});