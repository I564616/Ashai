 ...
 */
package com.asahi.staff.storefront.filters.cms;
...
public class CMSSiteFilter extends OncePerRequestFilter implements CMSFilter
{
			...
			throws IOException
	{
		...
		else if (!SiteChannel.B2C.equals(cmsSiteModel.getChannel()) && !SiteChannel.B2B.equals(cmsSiteModel.getChannel())) // Restrict to B2C channel
		{
