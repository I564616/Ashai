 ...
 *
 */
public abstract class AbstractAsahiStaffRegisterPageController extends AbstractAsahiStaffPageController
{
	protected static final Logger LOG = Logger.getLogger(AbstractAsahiStaffRegisterPageController.class);
			...
			final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		...
		//		try
		//		{
		//			//getEmployeeFacade().register(data);
