 ...
 *
 */
public class AbstractAsahiStaffSearchPageController extends AbstractAsahiStaffPageController
{
	...
	{
		return getSiteConfigService().getInt("asahi.storefront.search.pageSize", 10);
	}
