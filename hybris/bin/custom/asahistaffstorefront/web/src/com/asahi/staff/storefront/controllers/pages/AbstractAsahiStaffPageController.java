 ...
 *
 */
public class AbstractAsahiStaffPageController extends AbstractController
{
	protected static final Logger LOG = Logger.getLogger(AbstractAsahiStaffPageController.class);
	...
	{
		return employeeFacade.getCurrentEmployee();
	}
	...
	protected ContentPageModel getContentPageForLabelOrId(final String labelOrId) throws CMSItemNotFoundException
	{
		...
		if (StringUtils.isEmpty(labelOrId))
		{
			...
			homePage.getCatalogVersion().getCatalog().getId();
			if (homePage != null)
			{
