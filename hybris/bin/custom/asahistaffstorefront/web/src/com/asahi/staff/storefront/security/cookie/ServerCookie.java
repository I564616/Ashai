 ...
 *
 */
package com.asahi.staff.storefront.security.cookie;
...
public class ServerCookie implements Serializable
{
	...
	public static final class CookieSupport
	{
		...
		static
		{
			...
			ALLOW_HTTP_SEPARATORS_IN_V0 = Boolean
					.valueOf(System.getProperty("org.apache.tomcat.util.http.ServerCookie.ALLOW_HTTP_SEPARATORS_IN_V0", "false"))
					.booleanValue();
			...
			ALLOW_NAME_ONLY = Boolean
					.valueOf(System.getProperty("org.apache.tomcat.util.http.ServerCookie.ALLOW_NAME_ONLY", "false")).booleanValue();
