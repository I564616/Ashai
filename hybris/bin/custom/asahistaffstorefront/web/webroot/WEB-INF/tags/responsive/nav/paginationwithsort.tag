		...
		<div class="pagination-toolbar">
			...
			<div class="sort-refine-bar">
						...
						<div class="col-xs-12 col-sm-7 col-md-12">
									...
									<div class="prices-text">
										...
										<c:choose>
											<c:when test="${cmsSite.uid eq 'sga'}">
												<span><spring:theme code="sga.product.details.page.price.exclude" /></span>
											</c:when>
											<c:otherwise>
												<span><spring:theme code="plp.price.exclude.gst" /></span>
											</c:otherwise>
										</c:choose>
										</sec:authorize>
									</div>
                                        ...
                                        <c:forEach items="${searchPageData.sorts}" var="sort">
                                            <option value="${fn:escapeXml(sort.code)}" ${sort.selected? 'selected="selected"' : ''}>
												...
												<ul id="sortOptions${top ? '1' : '2'}" class="sortby_list">
													<c:forEach items="${searchPageData.sorts}" var="sort">
														<li data-option="${fn:escapeXml(sort.code)}" ${sort.selected? 'class="sel"' : ''}>
															<c:choose>
																<c:when test="${not empty sort.name}">
																	${fn:escapeXml(sort.name)}
																</c:when>
                            ...
                            <div class="form-group">
                                 ...
                                 <select class="form-control">
									...
									<%-- 	<div class="col-xs-12 col-sm-6 col-md-4 pagination-wrap">
                ...
                <div class="col-xs-12 col-sm-4 col-md-2">
                    <div class="pagination-bar-results-top">
                        <ycommerce:testId code="searchResults_productsFound_label">
                            <c:choose>
