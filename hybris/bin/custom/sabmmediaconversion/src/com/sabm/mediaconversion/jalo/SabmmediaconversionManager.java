 ...
 */
package com.sabm.mediaconversion.jalo;
...
import com.sabm.mediaconversion.constants.SabmmediaconversionConstants;



/**
 * This is the extension manager of the Sabmmediaconversion extension.
 */
public class SabmmediaconversionManager extends GeneratedSabmmediaconversionManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SabmmediaconversionManager.class);
	 ...
	 */
	public static SabmmediaconversionManager getInstance()
	{
		return (SabmmediaconversionManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SabmmediaconversionConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SabmmediaconversionManager() // NOPMD 
	{
		LOG.debug("constructor of SabmmediaconversionManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SabmmediaconversionManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SabmmediaconversionManager called, current tenant: {}", getTenant().getTenantID());
	}
