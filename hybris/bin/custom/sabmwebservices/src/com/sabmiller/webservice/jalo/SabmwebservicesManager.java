 ...
 *  
 */
package com.sabmiller.webservice.jalo;
...
import com.sabmiller.webservice.constants.SabmwebservicesConstants;



/**
 * This is the extension manager of the Sabmwebservices extension.
 */
public class SabmwebservicesManager extends GeneratedSabmwebservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SabmwebservicesManager.class.getName());
	 ...
	 */
	public static SabmwebservicesManager getInstance()
	{
		return (SabmwebservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SabmwebservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SabmwebservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SabmwebservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SabmwebservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SabmwebservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
