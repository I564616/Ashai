 ...
 */
public class SalesforceEmailRequestData {
    ...
    @JsonProperty(value = "JSON__c", required = false)
    public String json_c;
	

    public SalesforceEmailRequestData() {
     ...
     * @param object
     */
    public SalesforceEmailRequestData(SalesforceEmailJsonData jsonData, String address, String subscriberKey, Object object,String eventId) {
    ...
    public void setJson_c(SalesforceEmailJsonData jsonData){
    	try{
    		
    		ObjectMapper mapper = new ObjectMapper();
            this.json_c = mapper.writeValueAsString(jsonData);
