...
public class SABMSalesForceWelcomeMailPostHandler extends DefaultSABMSFPostRestRequestHandler<SalesForceEmailSmsPostRequest, SalesForceEmailSmsPostResponse>
{
	...
	{
		return Config.getString("salesforce.welcome.email_post_url", "");
	}
