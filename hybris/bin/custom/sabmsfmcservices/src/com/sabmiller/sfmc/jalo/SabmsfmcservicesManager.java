 ...
 *  
 */
package com.sabmiller.sfmc.jalo;
...
/**
 * This is the extension manager of the Sabmsfmcservices extension.
 */
public class SabmsfmcservicesManager extends GeneratedSabmsfmcservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SabmsfmcservicesManager.class.getName());
	 ...
	 */
	public static SabmsfmcservicesManager getInstance()
	{
		return (SabmsfmcservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SabmsfmcservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SabmsfmcservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SabmsfmcservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SabmsfmcservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SabmsfmcservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
